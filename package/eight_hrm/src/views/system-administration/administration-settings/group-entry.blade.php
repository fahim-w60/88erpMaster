            ...
            <div class="card col-5">
              <div class="card-body">
                    ...
                    <table>
                        <tr>
                            <td>Company Code </td>
                            <td><input type="text" value="{{old('compCode')}}" class="form-control" placeholder="Login ID" id="compCode" name="compCode"></td>
                            <td>
                        </tr>
                        <tr>
                            <td>Company Name </td>
                            <td><input type="text" value="{{old('compName')}}" class="form-control" placeholder="Full Name" name="compName" id="compName"></td>
                        </tr>
                        <tr>
                             <td>License No.</td>
                            <td><input type="text" value="{{old('liNo')}}" class="form-control" placeholder="liNo" name="liNo" id="liNo"></td>
                        </tr>
                        <tr>
                             <td>Street Address</td>
                            <td><textarea type="text" value="{{old('streetadd')}}" class="form-control" placeholder="" name="streetadd" id="streetadd"></textarea></td>
                        </tr>
                        <tr>
                            <td>Mobile No</td>
                        ...
                        <tr>
                            <td>Phone No</td>
                            <td><input type="text" value="{{old('phone')}}" class="form-control" placeholder="" name="phone" id="phone"></td>
                              
                        </tr>
                        <tr>
                            <td>Email</td>
                            <td><input type="email" value="{{old('email')}}" class="form-control" placeholder="example@xyz.com" name="email" id="email"></td>
                              
                        </tr>
                        <tr>
                            <td>Website</td>
                            <td><input type="text" value="{{old('website')}}" class="form-control" placeholder="" name="web" id="web"></td>
                              
                        </tr>
                        <tr>
                            <td>Slogan Text</td>
                            <textarea type="text" class="form-control" placeholder="" name="slogan" id="slogan"></textare>
                            
                        </tr>
                        <tr>
                            <td>Date Format</td>
                            <td><input type="text"  class="form-control datepicker"  name="date" id="date"></td>
                        </tr>
                        <tr>
                            <td>Currency</td>
                            <td><select class="form-select form-control" value="{{old('currency')}}"  aria-label="Default select example" name="currency" id="currency">
                                <option selected>Select</option>
                                <option value="1">Bangladeshi Taka</option>
                                <option value="2">US DOllar $</option>
                                <option value="3">Indian Rupie</option>
                              </select>
                              
                        </tr>
                        <tr>
                            <td>Logo Alignment</td>
                            <td class="form-check">
                                <input type="radio" value="{{old('square')}}" class="form-check-input"  name="square" id="square" checked>
                                <label class="form-check-label" for="square">Square </label>
                                <input type="radio" value="{{old('hor')}}" class="form-check-input"  name="hor" id="hor" >
                                <label class="form-check-label" for="hor">Horizontal </label>
                                <input type="radio" value="{{old('ver')}}" class="form-check-input"  name="ver" id="ver" >
                                <label class="form-check-label" for="ver">Vertical </label>
                            </td>
                        </tr>
                        <tr>
                            <td>Address</td>
