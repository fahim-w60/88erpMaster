                ...
                <div class="w-50">
                    <table>    
                            ...
                            <tr>
                                ...
                                <td><input class="form-control" type="text" value="{{ old('attendance_start_date') }}" name="attendance_start_date" id="attendance_start_date"></td>
                            </tr>
                            
                            <tr>
                               <td class="text-right"><label>To Date</label> </td>
                                <td><input class="form-control" type="date" name="attendance_end_date" value="{{ old('attendance_end_date')}} " id="attendance_end_date"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="text-right"><label>Select Roaster Group</label></td>
                                <td>
                                    <select class="form-control" name="roaster_group" id="roaster_group">
                                        <option class="form-control" value="option1">option1</option>
                                        <option class="form-control" value="option2">Option 2</option>
                                        <option class="form-control" value="option3">Option 3</option>
                                    </select>
...
document.addEventListener('DOMContentLoaded', function() {
        flatpickr("#attendance_start_date", {
            enableTime: true,
            dateFormat: "Y-m-d",
            defaultDate: "{{ old('attendance_start_date') }}"
        });
    });

    document.addEventListener('DOMContentLoaded', function() {
        flatpickr("#attendance_end_date", {
            enableTime: true,
            dateFormat: "Y-m-d",
            defaultDate: "{{ old('attendance_end_date') }}"
        });
    });
