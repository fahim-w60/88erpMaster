                ...
                {!! Form::open(array('route' => 'branch.store','method'=>'POST')) !!}
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Address:</label>
                                <input type="text" name="_address" class="form-control" placeholder="Address"  value="{{old('_address')}}">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Date:</label>
                                <input type="date" name="_date" class="form-control" placeholder="Date"  value="{{old('_date')}}">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Email:</label>
                                <input type="email" name="_email" class="form-control" placeholder="Email"  value="{{old('_email')}}">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Phone:</label>
                                <input type="text" name="_phone" class="form-control" placeholder="Phone"  value="{{old('_phone')}}">
                            </div>
                        </div>
